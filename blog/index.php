            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Create Blog</a>
                    </div>
                    <?php
                    // Include config file
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="delete.php?id='. $row['id'] .'" data-toggle="tooltip"><span class="fa fa-trash"></span> Delete</a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
